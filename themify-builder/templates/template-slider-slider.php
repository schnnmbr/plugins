		...
		<li style="<?php echo !empty($left_margin) ? 'margin-left:'.$left_margin.';' : ''; ?> <?php echo !empty($right_margin) ? 'margin-right:'.$right_margin.';' : ''; ?>">
			...
			if ( $hide_feat_img_slider == '' || $hide_feat_img_slider == 'no' ) {   
				...
				if ( $post_image || themify_check('video_url') == 1 ){ ?>
					...
					<figure class="slide-image">
						...
						<?php else: ?>
							<a href="<?php echo esc_url( $ext_link ); ?>" <?php if ( 'lightbox' == $ext_link_type ) : echo 'class="lightbox" rel="prettyPhoto[slider]"'; endif; ?> title="<?php echo the_title_attribute('echo=0'); ?>" <?php if ( 'yes' == $open_link_new_tab_slider ) : echo 'target="_blank"'; endif; ?>>
								<?php echo wp_kses_post( $post_image ); ?>
							</a>
						<?php endif; ?>
					</figure>
			...
			<div class="slide-content">
				<?php if ( $hide_post_title_slider == '' || $hide_post_title_slider == 'no' ): ?>
					...
					<?php else: ?>
						<h3 class="slide-title"><a href="<?php echo esc_url( $ext_link ); ?>" <?php if ( 'lightbox' == $ext_link_type ) : echo 'class="lightbox" rel="prettyPhoto[slider]"'; endif; ?> title="<?php the_title_attribute(); ?>" <?php if ( 'yes' == $open_link_new_tab_slider ) : echo 'target="_blank"'; endif; ?>><?php the_title(); ?></a></h3>
