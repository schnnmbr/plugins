		...
		<div class="themify_builder_field <?php echo isset( $option['wrap_with_class'] ) ? esc_attr( $option['wrap_with_class'] ) : ''; ?>">
			...
			<?php elseif( $option['type'] == 'select' ) : ?>
				...
				<?php elseif( 'checkbox' == $option['type'] ): ?>
					...
					<div id="<?php echo esc_attr( $option['id'] ); ?>" class="tfb_lb_option themify-checkbox">
					<?php foreach( $option['options'] as $opt): ?>
						...
						?>
						<input id="<?php echo esc_attr( $option['id'] . '_' . $opt['name'] ); ?>" name="<?php echo esc_attr( $option['id'] ); ?>[]" type="checkbox" class="tf-checkbox" value="<?php echo esc_attr( $opt['name'] ); ?>" <?php echo $checkbox_checked; ?> />
						<label for="<?php echo esc_attr( $option['id'] . '_' . $opt['name'] ); ?>" class="pad-right"><?php echo wp_kses_post( $opt['value'] ); ?></label>
