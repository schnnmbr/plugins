...
class TB_Testimonial_Module extends Themify_Builder_Module {
	function __construct() {
		...
		// Load Post Type
		///////////////////////////////////////
		add_action( 'init', array( $this, 'testimonial_loaded' ) );
		add_filter( 'post_updated_messages', array( $this, 'testimonial_updated_messages' ) );
	}

	function testimonial_loaded() {
		global $ThemifyBuilder;

		if ( post_type_exists( 'testimonial' ) ) {
			// check taxonomy register
			if ( ! taxonomy_exists( 'testimonial-category' ) )
				$this->testimonial_register_taxonomy();
		} else {
			$this->testimonial_register_cpt();
			$this->testimonial_register_taxonomy();
			add_filter( 'themify_do_metaboxes', array( $this, 'testimonial_meta_boxes' ) );
	 ...
	 * @return array
	 */
	function testimonial_register_cpt( $cpt = array() ) {
		$cpt = array(
	 ...
	 * @return void
	 */
	function testimonial_register_taxonomy( $cpt = array() ) {
		global $ThemifyBuilder;
		...
		add_filter( 'manage_taxonomies_for_testimonial_columns', array( $this, 'testimonial_category_columns' ) );
	}
	 ...
	 * @return array
	 */
	function testimonial_category_columns( $taxonomies ) {
