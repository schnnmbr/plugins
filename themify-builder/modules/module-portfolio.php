...
class TB_Portfolio_Module extends Themify_Builder_Module {
	function __construct() {
		...
		// Load Post Type
		///////////////////////////////////////
		add_action( 'init', array( $this, 'portfolio_loaded' ) );
	...
	function portfolio_loaded() {
		...
		if ( post_type_exists( 'portfolio' ) ) {
			...
			if ( ! taxonomy_exists( 'portfolio-category' ) ) 
				$this->portfolio_register_taxonomy();
		} else {
			$this->portfolio_register_cpt();
			$this->portfolio_register_taxonomy();
			add_filter( 'themify_do_metaboxes', array( $this, 'portfolio_meta_boxes' ) );
	 ...
	 * @return void
	 */
	function portfolio_register_cpt( $cpt = array() ) {
		$cpt = array(
	 ...
	 * @return type
	 */
	function portfolio_register_taxonomy( $cpt = array() ) {
		global $ThemifyBuilder;
		...
		add_filter( 'manage_taxonomies_for_portfolio_columns', array( $this, 'portfolio_category_columns' ) );
	 ...
	 * @return array
	 */
	function portfolio_category_columns( $taxonomies ) {
