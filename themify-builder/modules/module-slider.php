...
class TB_Slider_Module extends Themify_Builder_Module {
	function __construct() {
		...
		// Load Post Type
		///////////////////////////////////////
		add_action( 'init', array( $this, 'slider_loaded' ) );
	...
	function slider_loaded() {
		...
		if ( post_type_exists( 'slider' ) ) {
			...
			if ( ! taxonomy_exists( 'slider-category' ) ) 
				$this->slider_register_taxonomy();
		} else {
			$this->slider_register_cpt();
			$this->slider_register_taxonomy();
			add_filter( 'themify_do_metaboxes', array( $this, 'slider_meta_boxes' ) );
	 ...
	 * @return void
	 */
	function slider_register_cpt( $cpt = array() ) {
		$cpt = array(
	 ...
	 * @return void
	 */
	function slider_register_taxonomy( $cpt = array() ) {
		global $ThemifyBuilder;
		...
		add_filter( 'manage_taxonomies_for_slider_columns', array( $this, 'slider_category_columns' ) );
	}
	 ...
	 * @return array
	 */
	function slider_category_columns( $taxonomies ) {
