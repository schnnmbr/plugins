...
class TB_Highlight_Module extends Themify_Builder_Module {
	function __construct() {
		...
		// Load Post Type
		///////////////////////////////////////
		add_action( 'init', array( $this, 'highlight_loaded' ) );
		add_filter( 'post_updated_messages', array( $this, 'highlight_updated_messages' ) );
	}

	function highlight_loaded() {
		global $ThemifyBuilder;

		if ( post_type_exists( 'highlight' ) ) {
			// check taxonomy register
			if ( ! taxonomy_exists( 'highlight-category' ) ) {
				$this->highlight_register_taxonomy();
			}
		} else {
			$this->highlight_register_cpt();
			$this->highlight_register_taxonomy();
			add_filter( 'themify_do_metaboxes', array( $this, 'highlight_meta_boxes' ) );
	 ...
	 * @return mixed
	 */
	function highlight_updated_messages( $messages ) {
		global $post;
	 ...
	 * @return void
	 */
	function highlight_register_cpt( $cpt = array() ) {
		$cpt = array(
	 ...
	 * @return void
	 */
	function highlight_register_taxonomy( $cpt = array() ) {
		global $ThemifyBuilder;
		...
		add_filter( 'manage_taxonomies_for_highlight_columns', array( $this, 'highlight_category_columns' ) );
	}
	 ...
	 * @return array
	 */
	function highlight_category_columns( $taxonomies ) {
	 ...
	 * @return array
	 */
	function highlight_meta_boxes( $meta_boxes ) {
		global $ThemifyBuilder;
