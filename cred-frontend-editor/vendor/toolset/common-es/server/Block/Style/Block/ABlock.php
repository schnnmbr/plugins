...
abstract class ABlock implements IBlock {
	 ...
	 *
	 * @param string $storage_key If not explicit set, the style attribute name will be used.
	 *
	 * @return void
	 */
	...
	private function filter_for_id_generation( &$config ) {
		...
		$ignored_keys = [ 'content', 'fontCode', 'translatedWithWPMLTM', 'wpmlTranslatedContent' ];
