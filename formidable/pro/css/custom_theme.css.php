...
.frm_form_fields div.rating-cancel a{background:url(<?php echo FrmAppHelper::plugin_url() ?>/pro/images/delete.png) no-repeat 0 -16px;}
.frm_form_fields div.star-rating, .frm_form_fields div.star-rating a{background:url(<?php echo FrmAppHelper::plugin_url() ?>/pro/images/star.png) no-repeat 0 0px;}
