...
if (is_array($field['options'])){
    ...
    $star = (isset($field['star']) and $field['star']);  
    foreach($field['options'] as $opt_key => $opt){
        ...
        ?>
<?php if(!$star){ ?><div class="frm_scale <?php echo $last ?>"><label for="field_<?php echo $field['id']?>-<?php echo $opt_key ?>"><?php } ?>
...
<?php if(!$star){ ?> <?php echo $opt ?></label>
</div>   
<?php } 
