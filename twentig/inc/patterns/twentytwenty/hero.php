...
twentig_register_block_pattern(
	...
	array(
		...
		'categories' => array( 'hero' ),
		'content'    => '<!-- wp:group {"backgroundColor":"subtle-background","align":"full","className":"tw-pb-0"} --><div class="wp-block-group alignfull has-subtle-background-background-color has-background tw-pb-0"><div class="wp-block-group__inner-container"><!-- wp:heading {"textAlign":"center","level":1,"align":"wide"} --><h1 class="alignwide has-text-align-center">' . esc_html_x( 'Write the page title', 'Block pattern content', 'twentig' ) . '</h1><!-- /wp:heading --><!-- wp:paragraph {"align":"center","fontSize":"large"} --><p class="has-text-align-center has-large-font-size">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p><!-- /wp:paragraph --><!-- wp:image {"className":"tw-mt-9"} --><figure class="wp-block-image tw-mt-9"><img src="' . twentig_get_pattern_asset( 'illustration.svg' ) . '" alt=""/></figure><!-- /wp:image --></div></div><!-- /wp:group -->',
	)
);
