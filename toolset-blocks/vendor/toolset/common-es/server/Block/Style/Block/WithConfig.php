...
class WithConfig extends ABlock {
	 ...
	 */
	public function __construct( $block_config, Block $config, $block_name_for_id_generation = null ) {
	...
	public function get_block_config() {
		if( $this->block_config === null ) {
			$this->block_config = $this->get_block_setup()
									   ->merge_template_source_defaults_to_attributes( parent::get_block_config() );
		}
