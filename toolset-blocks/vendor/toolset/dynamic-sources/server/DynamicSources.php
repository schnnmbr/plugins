...
class DynamicSources {
	...
	public function register_sources( $view_id = null ) {
		...
		$this->sources_for_registration = $this->sources_registration_factory->adapt_sources_for_post_type( $post_type, $this->sources_for_registration );
	...
	public function register_localization_data() {
		...
		wp_enqueue_script(
			...
			TOOLSET_DYNAMIC_SOURCES_LOADED,
			false
		);
		wp_enqueue_style(
