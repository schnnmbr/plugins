...
/**
 * This class a clone of the core WP_List_Table class and in order to be used it needs to be copied on DS codebase as per
 * the core devs suggestion.
 *
 * @link https://developer.wordpress.org/reference/classes/wp_list_table/#more-information
 *
 * @codeCoverageIgnore
 */
class WPListTable {
