...
<form class="cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="woocommerce-grouped-product-list wooviews-template-table group_table">
		<tbody>
			<?php
				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {
						...
						case 'label':
							...
							break;
						case 'price':
							$value = '<span class="wooviews-template-amount">';
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button wooviews-template-add_to_cart_button button alt"><span class="wooviews-template-add_to_cart_button__icon"></span><span class="wooviews-template-add_to_cart_button__text"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></span></button>
